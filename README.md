...
The second version picks words from the first chapter of Mary Shelly's Frankenstein on Project Gutenberg, which means you need to be online, it is slower to execute and the pool of words is limited. However, it should run on most OS. You might need to install the requests library, if you do not have it already.
